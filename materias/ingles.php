...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['nuevo_comentario']) && isset($_SESSION['id_estudiante'])) {
    ...
    if ($comentario) {
        ...
        $stmt_add->execute();
        $stmt_add->close();
        header("Location: ingles.php?id_clase=$id_clase#comentarios");
        exit;
    }
}
?>
    ...
    <div class="main-content">
        <header>
            <a href="../cursos.php" class="logo modern-back">
                ...
                <span class="header-title" data-i18n="segundo">Segundo año B <span class="header-materia">Inglés</span></span>
            </a>
            <div class="icons">
                <span class="profile">
