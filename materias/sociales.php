...
<body>
    <header>
        <a href="../cursos.php" class="logo">
            <i class="fas fa-arrow-left"></i> Segundo año B - Sociales
        </a>
        <div class="icons">
        ...
        <section id="tareas" class="seccion" style="display: none;">
            ...
            <ul class="lista-tareas">
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Tarea de Historia Universal', 'Resolver los problemas de historia universal del capítulo 3. Entregar antes del próximo lunes.')">Añadir tarea</button>
                </li>
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Proyecto de Geografía', 'Crear un proyecto sobre la geografía de un país. Entregar en clase el próximo miércoles.')">Añadir tarea</button>
                </li>
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Examen de Ciencias Sociales', 'Estudiar para el examen de ciencias sociales que se realizará el próximo viernes. Revisar los apuntes y resolver los ejercicios del capítulo 2.')">Añadir tarea</button>
                </li>
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Tarea de Economía', 'Escribir un ensayo sobre la importancia de la economía en la sociedad. Entregar antes del próximo jueves.')">Añadir tarea</button>
                </li>
            </ul>
        </section>
