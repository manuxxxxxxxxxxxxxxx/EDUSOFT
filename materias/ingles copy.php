...
<div class="main-content">
    <header>
        <a href="../extracurriculares.php" class="logo modern-back">
            ...
            <span data-i18n="segundo" class="header-title">Segundo año B <span class="header-materia" data-i18n="ingles">Biología</span></span>
        </a>
        <div class="icons">
    ...
    <?php if (isset($_SESSION['id_estudiante'])): ?>
        <h2 data-i18n="sube">Sube tu tarea de Inglés</h2>
