...
if (!isset($_SESSION['id']) && !isset($_SESSION['id_estudiante'])) {
    die("Debes iniciar sesión como profesor o estudiante para acceder a esta materia.");
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['nuevo_comentario']) && isset($_SESSION['id_estudiante'])) {
    ...
    if ($comentario) {
        ...
        $stmt_add->execute();
        $stmt_add->close();
        header("Location: ciencias.php?id_clase=$id_clase#comentarios");
        exit;
    }
}
?>
    ...
    <div class="main-content">
        <header>
            <a href="../cursos.php" class="logo modern-back">
                ...
                <span class="header-title">Segundo año B <span class="header-materia">Ciencias</span></span>
            </a>
            <div class="icons">
              <span class="profile">
        ...
        <main>
            <section id="tablon" class="seccion">
                <div class="banner banner-ciencia" id="banner-ciencias">
    ...
    <ul style="list-style:none;padding-left:0;">
        ...
        <?php endif; ?>
            ...
            <section id="material" class="seccion" style="display: none;">
                ...
                <?php
                if (!$id_clase) {
                    echo "<p>Clase no especificada.</p>";
                } else {
