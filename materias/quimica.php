...
<body>
    <header>
        <a href="../cursos.php" class="logo">
            <i class="fas fa-arrow-left"></i> Segundo año B - Química
        </a>
        <div class="icons">
            ...
            <section id="tablon" class="seccion">
                ...
                <div class="content">
                    ...
                    <div class="anuncios">
                        ...
                        <div class="tarea" data-titulo="Proyecto de Química Inorgánica" data-descripcion="Crear un proyecto sobre la química orgánica. Entregar en clase el próximo miércoles.">
        ...
        <section id="tareas" class="seccion" style="display: none;">
            ...
            <ul class="lista-tareas">
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Tarea de Química Inorgánica', 'Resolver los problemas de química inorgánica del capítulo 3. Entregar antes del próximo lunes.')">Añadir tarea</button>
                </li>
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Proyecto de Química Orgánica', 'Crear un proyecto sobre la química orgánica. Entregar en clase el próximo miércoles.')">Añadir tarea</button>
                </li>
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Examen de Química Física', 'Estudiar para el examen de química física que se realizará el próximo viernes. Revisar los apuntes y resolver los ejercicios del capítulo 2.')">Añadir tarea</button>
                </li>
                <li>
                    ...
                    <button class="boton-estilo" onclick="abrirModal('Tarea de Química Analítica', 'Escribir un ensayo sobre la importancia de la química analítica en la industria. Entregar antes del próximo jueves.')">Añadir tarea</button>
                </li>
            </ul>
        </section>
